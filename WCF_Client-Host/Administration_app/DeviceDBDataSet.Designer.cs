...
namespace Administration_app {
    ...
    public partial class DeviceDBDataSet : global::System.Data.DataSet {
        ...
        public partial class DevicesDataTable : global::System.Data.TypedTableBase<DevicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DevicesRow AddDevicesRow(int Device_ID, string Message) {
        ...
        public partial class DevicesRow : global::System.Data.DataRow {
            ...
            public string Message {
                get {
                    try {
                        return ((string)(this[this.tableDevices.MessageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Hodnota pro sloupec Message v tabulce Devices je rovna hodnotě DBNull.", e);
                    }
                }
                set {
                    this[this.tableDevices.MessageColumn] = value;
                }
            }
            ...
            public bool IsMessageNull() {
                return this.IsNull(this.tableDevices.MessageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetMessageNull() {
                this[this.tableDevices.MessageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Administration_app.DeviceDBDataSetTableAdapters {
    ...
    public partial class DevicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Devices] WHERE (([Id] = @Original_Id) AND ([Device_ID] = @Orig" +
                "inal_Device_ID) AND ((@IsNull_Message = 1 AND [Message] IS NULL) OR ([Message] =" +
                " @Original_Message)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Devices] ([Device_ID], [Message]) VALUES (@Device_ID, @Message" +
                ");\r\nSELECT Id, Device_ID, Message FROM Devices WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Devices] SET [Device_ID] = @Device_ID, [Message] = @Message WHERE (([Id] = @Original_Id) AND ([Device_ID] = @Original_Device_ID) AND ((@IsNull_Message = 1 AND [Message] IS NULL) OR ([Message] = @Original_Message)));
SELECT Id, Device_ID, Message FROM Devices WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Administration_app.Properties.Settings.Default.DeviceDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Device_ID, Message FROM dbo.Devices";
        ...
        public virtual int Fill(DeviceDBDataSet.DevicesDataTable dataTable) {
        ...
        public virtual DeviceDBDataSet.DevicesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DeviceDBDataSet.DevicesDataTable dataTable = new DeviceDBDataSet.DevicesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DeviceDBDataSet.DevicesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_Device_ID, string Original_Message) {
        ...
        public virtual int Insert(int Device_ID, string Message) {
        ...
        public virtual int Update(int Device_ID, string Message, int Original_Id, int Original_Device_ID, string Original_Message, int Id) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_Device_ID));
            if ((Original_Message == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Device_ID, string Message, int Original_Id, int Original_Device_ID, string Original_Message) {
            return this.Update(Device_ID, Message, Original_Id, Original_Device_ID, Original_Message, Original_Id);
        }
    }
